...
public class PedidoMapeador {
    public static PedidoDTO paraDTO(Pedido pedido) {
        PedidoDTO dto = new PedidoDTO(pedido.getId(),
                ...
                new PagamentoDTO(pedido.getPagamento().getId(), pedido.getPagamento().getMeioPagamento(), pedido.getPagamento().getQtdParcela(), pedido.getPagamento().getValorAcrescimo(), pedido.getPagamento().getValorDesconto(), pedido.getPagamento().getValorTotal()));
    ...
    public static Pedido deDTO(PedidoDTO dto) {
        Pedido entidade = new Pedido(dto.getId(),
                ...
                new Pagamento(dto.getPagamento().getId(), dto.getPagamento().getMeioPagamento(), dto.getPagamento().getQtdParcela(), dto.getPagamento().getValorAcrescimo(), dto.getPagamento().getValorDesconto(), dto.getPagamento().getValorTotal()));
